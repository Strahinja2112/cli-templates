...
export default function App() {
  return (
    <RootLayout>
      <div className="w-full h-screen bg-[radial-gradient(ellipse_at_top_left,_var(--tw-gradient-stops))] flex flex-col gap-[30px] items-center justify-center from-black via-[rgb(5,18,4)] to-black">
